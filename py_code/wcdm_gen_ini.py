...
for i in range(len(trial_arr)):
    trial = data[i,0]
    file = open('../class/ini_files/wcdm/lhs_lin_%s.ini' %trial, 'w')
    h = float(data[i,1])
    Omega_b = float(data[i,2])
    Omega_cdm = float(data[i,3])
    A_s = float(data[i,4])
    n_s = float(data[i,5])
    Omega_k = float(data[i,6])
    w0 = float(data[i,7])
    wa = float(data[i,8])
    ...
    file.write('A_s = %s\n' %A_s)
    file.write('n_s = %s\n' %n_s)
    file.write('Omega_k = %s\n' %Omega_k)
    file.write('w0_fld = %s\n' %w0)
    file.write('wa_fld = %s\n' %wa)
    file.write('root = output/wcdm/lin/lhs_lin_%s\n' %trial)
...
for i in range(len(trial_arr)):
    trial = data[i,0]
    file = open('../class/ini_files/wcdm/lhs_nonlin_%s.ini' %trial, 'w')
    h = float(data[i,1])
    Omega_b = float(data[i,2])
    Omega_cdm = float(data[i,3])
    A_s = float(data[i,4])
    ...
    file.write('w0_fld = %s\n' %w0)
    file.write('wa_fld = %s\n' %wa)
    file.write('root = output/wcdm/nonlin/lhs_nonlin_%s\n' %trial)
...
for i in range(len(trial_arr)):
    trial = data[i,0]
    file = open('../class/ini_files/wcdm/lhs_lin_pk_%s.ini' %trial, 'w')
    h = float(data[i,1])
    Omega_b = float(data[i,2])
    Omega_cdm = float(data[i,3])
    A_s = float(data[i,4])
    ...
    file.write('w0_fld = %s\n' %w0)
    file.write('wa_fld = %s\n' %wa)
    file.write('root = output/wcdm/lin/lhs_lin_pk_%s\n' %trial)
...
for i in range(len(trial_arr)):
    trial = data[i,0]
    file = open('../class/ini_files/wcdm/lhs_nonlin_pk_%s.ini' %trial, 'w')
    h = float(data[i,1])
    Omega_b = float(data[i,2])
    Omega_cdm = float(data[i,3])
    A_s = float(data[i,4])
    ...
    file.write('w0_fld = %s\n' %w0)
    file.write('wa_fld = %s\n' %wa)
    file.write('root = output/wcdm/nonlin/lhs_nonlin_pk_%s\n' %trial)
